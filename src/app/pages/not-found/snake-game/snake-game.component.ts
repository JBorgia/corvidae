...
export class SnakeGameComponent implements OnInit {
  ...
  gameStarted = false;
  newBestScore = false;
  best_score = this.bestScoreService.retrieve();
  ...
  constructor(
    ...
    private bestScoreService: SnakeGameService
  ) {
    this.setBoard();
  ...
  setColors(col: number, row: number): string {
    if (this.isGameOver) {
      ...
      return this.userService.userPrefs$.getValue().theme === 'dark-theme' ? DARKCOLORS.HEAD : COLORS.HEAD;
    } else if (this.board[col][row] === true) {
      return this.userService.userPrefs$.getValue().theme === 'dark-theme' ? DARKCOLORS.BODY : COLORS.BODY;
